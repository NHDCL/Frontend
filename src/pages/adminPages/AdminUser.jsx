          ...
          <tbody>
            {filteredData.map((item, index) => (
              <tr key={index}>
                ...
                <td>{item.role}</td>
                <td>
                  <RiDeleteBin6Line onClick={() => handleDelete(index)} style={{ width: "20px", height: "20px", color: "red" }} />
      ...
      {showModal && (
        <div className="AdminUser-modal-overlay">
          <div className="AdminU-modal-content">
            ...
            <h2>Add {activeTab}</h2>
            <button className="AdminUser-close-btn" onClick={() => setShowModal(false)}>
              <IoIosCloseCircle
            ...
            <div className="AdminUser-modal-content">
              ...
              <select required>
                  ...
                  <option value="Gyelpozhing">Gyelpozhing</option>
                  <option value="Tareythang">Tareythang</option>
              ...
              <button className="AdminUser-add" type="submit">Add</button>
            </div>
          </div>
        </div>
      )}
