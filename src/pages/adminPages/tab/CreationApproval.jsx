...
const CreationApproval = () => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({
          icon: "error",
          title: "Update Failed",
          text: "Unable to update asset. Please try again later.",
        });
      }
    }
  };
  ...
  const handleApprove = async (e) => {
    ...
    const result = await Swal.fire({
      title: "Are you sure?",
      text: "You are about to approve this asset.",
      icon: "warning",
      color: "#305845",
      showCancelButton: true,
      confirmButtonColor: "#305845",
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        Swal.fire({
          icon: "success",
          title: "Asset approved successfully!",
          toast: true,
          position: "top-end",
          showConfirmButton: false,
          timer: 2000,
        ...
        Swal.fire({
          ...
          text:
            error?.data?.message ||
            "Unable to approve the asset. Please try again later.",
        });
      } finally {
        setIsLoading(false);
      }
  ...
  const handleDecline = async (e) => {
    ...
    const result = await Swal.fire({
      title: "Are you sure?",
      text: "You are about to decline this asset.",
      icon: "warning",
      color: "#305845",
      showCancelButton: true,
      confirmButtonColor: "#305845",
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        Swal.fire({
          icon: "success",
          title: "Asset declined successfully!",
          toast: true,
          position: "top-end",
          showConfirmButton: false,
          timer: 2000,
        ...
        Swal.fire({
          ...
          text:
            error?.data?.message ||
            "Unable to decline the asset. Please try again later.",
        });
      } finally {
