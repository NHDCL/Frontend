...
export const adminnavigationLinks = [
    ...
    { id: 5, title: 'Asset Approval', path: "approval", icon: HiOutlineClipboardDocumentCheck },
    { id: 6, title: 'Repair and Maintenance', path: "repair-maintenance", icon: GiAutoRepair },
    { id: 7, title: 'Preventive Maintenance', path: "preventive-maintenance", icon: GrVmMaintenance },
    { id: 8, title: 'Repair Report', path: "repair-report", icon: TbReportSearch },
    { id: 9, title: 'Maintenance Report', path: "maintenance-report", icon: TbReport },
...
export const supervisornavigationLinks = [
    { id: 1, title: 'Home', path: "", icon: FaHome },
    { id: 2, title: 'Work Order', path: "work-order", icon: GrVmMaintenance },
    { id: 3, title: 'Repair Report', path: "repair-report", icon: TbReportSearch },
    { id: 4, title: 'Maintenance Report', path: "maintenance-report", icon: TbReport },
